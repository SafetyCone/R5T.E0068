...
namespace R5T.E0068
{
    class Program
    {
        static void Main()
        {
            //Explorations.Instance.RoundTrip_DeserializationSerialization();
            //Explorations.Instance.Output_FirstCode();
            //Explorations.Instance.Output_FullyFormedClass();
            //Explorations.Instance.Describe_Trivia();
            //Explorations.Instance.Display_WhitespaceTrivias();
            //Explorations.Instance.Display_TriviaList_Empty();
            //Explorations.Instance.Display_TriviaList_GeneratedDefault();
            //Explorations.Instance.Write_AllSyntaxTriviaSyntaxKinds();
            //Explorations.Instance.Create_MainMethod();
            ...
            //TriviaExperiments.Instance.WhatIf_MismatchedText();
            //TriviaExperiments.Instance.Discover_AllowedSyntaxTriviaSyntaxKinds();
            //TriviaExperiments.Instance.Determine_HowHasTriviaIsDetermined();
